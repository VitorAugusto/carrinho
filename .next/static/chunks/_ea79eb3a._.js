...
function ThemeProvider({ children, defaultTheme = "system", storageKey = "carrinho-theme", attribute = "class", enableSystem = true, disableTransitionOnChange = false, ...props }) {
    _s();
...
_s(ThemeProvider, "RTrxi86PiYagBpTDCpPct2uPZz8=");
_c = ThemeProvider;
const useTheme = ()=>{
    _s1();
